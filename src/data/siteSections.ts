...
export const siteSections: SiteSection[] = [
  ...
  { id: 'map', label: 'Conference Gallery', title: 'Conference Gallery', description: 'Explore OU’s league lineage from Big Six to SEC.', order: 2, featured: true },
  { id: 'fbs-landscape', label: '2026 Map', title: '2026 FBS Landscape', description: 'A national map of projected 2026 FBS conference alignment.', order: 3, featured: true },
  ...
  { id: 'nfl', label: 'Norman to NFL', title: 'From Norman to the NFL', description: 'Searchable OU-to-NFL starter database.', order: 7, featured: true },
